...
function getPhoneInputWithCountryStateUpdateFromNewProps(props, prevProps, state) {
  ...
  if (newDefaultCountry !== prevDefaultCountry && (0, _countries.isCountrySupportedWithError)(newDefaultCountry, metadata) && !hasUserSelectedACountry && // The `!newValue` check is added here to restrict the dynamically updated
